...
{
  public function testGenerateSignatureWithRequiredFields(): void
  {
    $options = new CheckoutOptions('INV-001', 'ZAR', 12.32, 'https://httpbin.org/post');
    $options->nonce = '0987654321';

    $body = CheckoutAPI::generateSignature('123', '321', $options);
  ...
  public function testGenerateSignatureWithAutoGeneratedNonce(): void
  {
    $options = new CheckoutOptions('INV-001', 'ZAR', 12.32, 'https://httpbin.org/post');
  ...
  public function testGenerateSignatureWithAllFields(): void
  {
    $options = new CheckoutOptions('INV-001', 'ZAR', 12.32, 'https://httpbin.org/post');
    $options->nonce = '0987654321';
